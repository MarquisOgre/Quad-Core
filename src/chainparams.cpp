...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ba073aa466621bd54c883d865f581e54d648246b5882f7bfc82cc482ae1")); 
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1535200000, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vTreasuryRewardAddress="QNmdzY4EZ9KPof8PeZLZ8wvr5NuAGDuhZu";// All the treasury rewards goes to this wallet, please dont lose this wallet
        strNetworkID = "main";
        /**
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "25 Aug 2018, Confusion continues as immigrant children remain separated from parents!!!";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535200000;// 
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2548985;       
/*
...
*/
        ...
        assert(hashGenesisBlock == uint256("0x00000ba073aa466621bd54c883d865f581e54d648246b5882f7bfc82cc482ae1"));
        assert(genesis.hashMerkleRoot == uint256("0x50f91b56b3da0cba7a79c44fa552233ecc7c31d86954e503c7084b7d58794ece"));

        vSeeds.push_back(CDNSSeedData("seed7", "45.77.163.248"));
        vSeeds.push_back(CDNSSeedData("seed8", "45.32.226.51"));
